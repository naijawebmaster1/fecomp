...
<head>
    ...
    <title>Fecomp | Admin Contact Us Messages Dashboard</title>
                   ...
                   <!-- end row -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Contact Messages</h4>
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while($row = mysqli_fetch_assoc($result)) { ?>
                                                ...
                                                <tr>
                                                     <td><?php echo $row['id']; ?></td><td><?php echo $row['name']; ?></td><td><?php echo $row['email']; ?></td><td><?php echo $row['message']; ?></td>  <center> <td style="text-align:center" ><a href="contact.php?del=<?php echo $row['id']; ?>"><i  class="fas fa-trash-alt"></i></a></td></center>
                                                </tr>       
                                         <?php
