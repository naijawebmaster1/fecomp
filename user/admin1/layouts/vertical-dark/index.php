...
<meta charset="utf-8">
    ...
    <title>Fecomp | Admin Membership Detail Dashboard</title>
                    ...
                    <li class="dropdown notification-list list-inline-item">
                        <div class="dropdown notification-list nav-pro-img"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                                ...
                                <div class="dropdown-divider"></div><a href="index.php?logout='1'" class="dropdown-item text-danger" href="logout.php"><i
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li><a href="index.php" class="waves-effect"><i class="ti-home"></i><span
                                ...
                                <li><a href="contact.php" class="waves-effect"><i class="ti-location-pin"></i><span
                                    class="badge badge-primary badge-pill float-right">5</span>
                                <span>Contact</span></a></li>

                                <li><a href="subscribe.php" class="waves-effect"><i class="ti-support"></i><span
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Fecomp</a></li>
                   ...
                   <!-- end row -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Menbers Details</h4>
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        $sql = "SELECT id, firstname, email, phone, age, address, department, interest FROM register";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while($row = mysqli_fetch_assoc($result)) { ?>
                                                ...
                                                <tr>
                                                     <td><?php echo $row['id']; ?></td><td><?php echo $row['firstname']; ?></td><td><?php echo $row['email']; ?></td><td><?php echo $row['phone']; ?></td><td><?php echo $row['age']; ?></td><td><?php echo $row['address']; ?></td><td><?php echo $row['department']; ?></td><td><?php echo $row['interest']; ?></td>  <center> <td style="text-align:center" ><a href="index.php?del=<?php echo $row['id']; ?>"><i  class="fas fa-trash-alt"></i></a> </td></center>
                                                </tr>       
                                         <?php
