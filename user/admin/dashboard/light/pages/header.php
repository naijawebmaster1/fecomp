            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.php">
                        ...
                        <span class="logo-default">BlueCross</span> </a>
                </div>
                <!-- logo end -->
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                                data-close-others="true">
                                <img alt="" class="img-circle " src="../assets/img/woman.svg" />
                            </a>
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <a href="../../../" target="_blank">
                                        <i class="fa fa-user"></i> site </a>
                                </li>
                                <li>
                                    <a href="https://dashboard.tawk.to/login" target="_blank">
                                        <i class="fa fa-cogs"></i> Live Chat
                                    </a>
                                </li>
                                <li>
                                    <a href="feedback.php">
                                        <i class="fa fa-question-circle"></i> Feed Backs
                                    </a>
                                </li>
                                <li class="divider"> </li>
                                <!-- <li>
