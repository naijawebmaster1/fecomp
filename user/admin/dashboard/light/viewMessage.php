...
function getDetailHotelBookings(){
   ...
   // $hotelName = $hotel['title'];
	...
	$sql = "SELECT * FROM feedback WHERE id='$id' /* AND published=true */ ";
...
<?php $bookingNo = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM feedback WHERE id='$id'")); ?>
    ...
    <div id="popup2" class="overlay" style="  z-index:10000 ;">
        <div class="popup" style="  z-index: 80999;    ">
            <div class="profile-userbuttons">
                ...
                <div class="content">
                     <h4> <!--Viewing FeedBack Message From
                        <?php// echo $bookings['firstName']; ?> with email
                        <?php // echo $bookings['email']; ?> -->
						<?php echo $bookings['subject']; ?>
                ...
                <br>
                <a href="<?php echo 'index.php'; ?>#feedback">
                    <button type="button"
        ...
        <div class="popup" style="  z-index: 80999;     background-color: #e91e63 !important;">
            <div class="profile-userbuttons">
                ...
                <div class="content" style=" color:#fff!important">
                    <h2 style=" color:#fff!important">Viewing FeedBack Message From
                        <?php echo $bookings['firstName']; ?> with email
                        <?php echo $bookings['email']; ?>?</h2>
