    ...
    <div id="popup2" class="overlay" style="  z-index:10000 ;">
        <div class="popup" style="  z-index: 80999;    ">
            <div class="profile-userbuttons">
                ...
                <div class="content">
                    <h2>Approve this booking for
                        <?php echo $bookings['firstName']; ?> 
                        <?php echo $bookings['lastName']; ?>?</h2>

                    An Email Would be sent To
                    <?php echo $bookings['email']; ?> confirming
                ...
                <a
                    href="includes/hotelBookingController.php?statusApproved=<?php echo $id; ?>&email=<?php echo $bookings['email']; ?>&tnxId=<?php echo $bookings['tnxId']; ?>">
    ...
    <div id="popup3" class="overlay" style="  z-index:10000">
        <div class="popup" style="  z-index: 80999;     background-color: #e91e63 !important;">
            <div class="profile-userbuttons">
                ...
                <a href="approveDeclineBookings.php?id=<?php echo $id; ?>#popup4">
        ...
        <div id="popup4" class="overlay" style="  z-index:10000; margin-top:0px!important; ">
        <div class="popup" style="  z-index: 80999;     background-color: #e91e63 !important; width: 35%">
            <form action="includes/hotelBookingController.php" method="GET">
                <input type="hidden" name="statusDeclined" value="<?=$id?>">
                <input type="hidden" name="email" value="<?php echo $bookings['email']; ?>">
                <input type="hidden" name="tnxId" value="<?php echo $bookings['tnxId']; ?>">
                <div class="profile-userbuttons">

                    <div class="content" style=" color:#fff!important">
                        <h2 style=" color:#fff!important">Reason For Booking Being declined!</h2>

                        "Thank you for booking an appointment with us at BlueCross Hospital. We are sincerely sorry for
                        any inconvinience this might have caused. However,

                        <!-- <input type="text" name="message" id=""> -->
                        <div class="col-lg-12 p-t-12" style="margin:auto; margin: 10px 0px;">
                            <div class="">
                                <textarea name="message" class="mdl-textfield__input" required required rows="1"
                                    id="text2" style="padding:0px 10px"></textarea>
                                <label class="mdl-textfield__label" for="text7"></label>
                            </div>
                        </div>



                        We will notify you by E-mail here on the progress status of your appointment. do check back here
                        Later."

                    </div>
                    <br>
                    <a href="approveDeclineBookings.php?id=<?php echo $id; ?>#popup3">

                        <button type="button"
                            class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary">Back</button>
                    </a>



                    <button type="submit"
                        class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-pink">Send</button>
